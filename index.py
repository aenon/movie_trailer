...
mr_donkey = movie.Movie("Mr. Donkey", 
	...
	"https://images-na.ssl-images-amazon.com/images/M/MV5BNGQ1MzcyYWItN2Q4NC0"
	"0YTlmLTg3NGEtMWY0Mzk0NDFjYTNiXkEyXkFqcGdeQXVyMjExMzEyNTM@._V1_SY1000_CR0"
	",0,666,1000_AL_.jpg")
...
twelve_citizens = movie.Movie("12 Citizens", 
  ...
  "https://images-na.ssl-images-amazon.com/images/M/MV5BNzcyZjlkYjUtMTdjZi00N"
  "Dc5LWIyMjMtMmEwMDYzMTBhOTMzXkEyXkFqcGdeQXVyMjg0MTI5NzQ@._V1_SY1000_CR0,0,7"
  "50,1000_AL_.jpg")
...
the_wasted_times = movie.Movie("The Wasted Times", 
  ...
  "https://images-na.ssl-images-amazon.com/images/M/MV5BZmE0ZmI2OTgtYjVkNS00Z"
  "DkxLTg1OTYtYjI3ZDYwMzgwYzY0XkEyXkFqcGdeQXVyMjExMzEyNTM@._V1_.jpg")
...
chungking_express = movie.Movie("Chungking Express", 
  ...
  "https://images-na.ssl-images-amazon.com/images/M/MV5BMjA5MTc3NDE2MV5BMl5Ba"
  "nBnXkFtZTcwMDM5MTk5MQ@@._V1_.jpg")
